                    ...
                    <div class="col-md-12">
                      <div class="col-md-12 p-4">
                        ...
                        <form method="post" action="{{route('client.store')}}" class="">
                          ...
                          <div class="form-row">
                            <div class="form-group col-md-6"> <input type="text" class="form-control" name="cpf" id="form36" placeholder="CPF" required="required"> </div>
                            <div class="form-group col-md-6"> <input type="text" class="form-control" name="rg" id="form36" placeholder="RG" required="required"> </div>
                          </div>
                          <div class="form-row">
                          ...
                          <div class="form-row">
                            <div class="form-group col-md-12"> <input type="text" class="form-control" name="cidade" id="form40" placeholder="Cidade" required="required"> </div>
                          </div>
                          <div class="form-row">
                            <div class="form-group col-md-6"> <input type="text" class="form-control" name="telefone" id="form41" placeholder="Telefone" > </div>
                            <div class="form-group col-md-6"> <input type="text" class="form-control" name="celular" id="form40" placeholder="Celular" > </div>
                          </div>
